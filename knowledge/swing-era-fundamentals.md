...
### Primary Scales
1. **Major Scale** (Ionian) - For major chords
2. **Mixolydian** - For dominant 7th chords
3. **Dorian** - For minor 7th chords
4. **Blues Scale** - For blues-influenced playing
5. **Pentatonic (Major & Minor)** - Universal application
